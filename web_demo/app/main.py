...
sourness = ['안신', '안시고',  '시지않은', '시지않고','새콤한','상큼한', '시지만', '조금시큼한','시고','신', '시큼한','시큼하고']
wine_type = ['레드', '화이트', '스파클링', '샴페인', '로제']
price = ['1만정도', '1만원정도', '1만원쯤', '1만원?', '1만?', '1만원이하', '1만이하', '2만정도', '2만원정도', '2만원쯤', '2만원?', '2만?','2만원이하', '2만이하', 
'3만정도', '3만원정도', '3만원쯤', '3만원?', '3만?', '3만원이하', '3만이하', '4만정도', '4만원정도', '4만원쯤', '4만원?', '4만?', '4만원이하', '4만이하',
'5만정도', '5만원정도', '5만원쯤', '5만원?', '5만?', '5만원이하', '5만이하', '6만정도', '6만원정도', '6만원쯤', '6만원?', '6만?', '6만원이하', '6만이하', 
'7만정도', '7만원정도', '7만원쯤', '7만원?', '7만?', '7만원이하', '7만이하', '8만정도', '8만원정도', '8만원쯤', '8만원?', '8만?', '8만원이하', '8만이하', 
'9만정도', '9만원정도', '9만원쯤', '9만원?', '9만?',  '9만원이하', '9만이하', '10만정도', '10만원정도', '10만원쯤', '10만원?', '10만?', '10만원이하', '10만이하', 
'20만정도', '20만원정도', '20만원쯤', '20만원?', '20만?',  '20만원이하', '20만이하', '30만정도', '30만원정도', '30만원쯤', '30만원?', '30만?', '30만원이하', '30만이하',
'40만정도', '40만원정도', '40만원쯤', '40만원?', '40만?',  '40만원이하', '40만이하', '50만정도', '50만원정도', '50만원쯤', '50만원?', '50만?', '50만원이하', '50만이하', 
'60만정도', '60만원정도', '60만원쯤', '60만원?', '60만?', '60만원이하', '60만이하', '70만정도', '70만원정도', '70만원쯤', '70만원?', '70만?', '70만원이하', '70만이하', 
'80만정도', '80만원정도', '80만원쯤', '80만원?', '80만?', '80만원이하', '80만이하', '90만정도', '90만원정도', '90만원쯤', '90만원?', '90만?', '90만원이하', '90만이하',
'100만정도', '100만원정도', '100만원쯤', '100만원?', '100만?','100만원이하', '100만이하']
 ##############################################################
...
def catch_slot(i, inferred_tags, text_arr, slot_text):
    if not inferred_tags[0][i] == "O": # 0(숫자)이 아니라 O(영어)이다
    ...
    if empty_slot:
        ...
        if userText.startswith("예"):
            ...
            try:
              ...
              price = wine_list.iloc[0]['금액']
              sweet_wine =  wine_list.iloc[0]['당도']
              sour_wine = wine_list.iloc[0]['산미']
              body_wine = wine_list.iloc[0]['바디감']
              res = requests.get(img)
              request_get_img = Image.open(BytesIO(res.content))
              message = f'''추천드릴 와인은
              {name} 입니다.
              이 와인은 {app.slot_dict['종류']}와인으로
              {sour_wine}의 산미,{body_wine}의 바디감,{sweet_wine}의 당도를 가지고 있고
              가격은 {price}원입니다.
              자세한 정보확인하시거나 구매를 위해서는
              {page}로 방문해보세요.
              '''
              return message,img
            except:
